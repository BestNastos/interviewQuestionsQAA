...
- до передачи пользователю - альфа-тестирование (alphatesting);
    ...
    - _тест сдачи_ (acceptance or certification test) - в т.ч. тесты по пофикшенным багам,
...
классификация по _**уровням** тестирования_.

Итак, **уровни тестирования**:
- _компонентное_ тестирование (component testing/unit);
- _интеграционное_ тестирование (integration testing);
- _системное (или энд-ту-энд)_ тестирование (system or end to-end testing).
...
### Какие тесты стоит автоматизировать, а какие нет?
...
- Эксплоратори тесты - они проводятся не по расписанным шагам, 
